        ...
        <Box sx={{
          ...
          <DataGrid
            ...
            processRowUpdate={(newRow) => {
              ...
              if (processedRow.deposit_from_star) {
                processedRow.deposit_from_star = toHalfWidth(String(processedRow.deposit_from_star));
              }
              if (processedRow.payment) {
                processedRow.payment = toHalfWidth(String(processedRow.payment));
              }
